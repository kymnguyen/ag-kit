      ...
      <div className="rounded-2xl border border-border bg-card p-8 md:p-10">
        <div className="grid grid-cols-2 gap-x-10 gap-y-8 md:grid-cols-4 xl:grid-cols-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <a
              href="https://github.com/kymnguyen/ag-kit/issues"
              target="_blank"
              rel="noopener noreferrer"
              className="opacity-75 hover:opacity-100"
            >
            ...
            <a
              href="https://github.com/kymnguyen/ag-kit/discussions"
              target="_blank"
              rel="noopener noreferrer"
              className="opacity-75 hover:opacity-100"
            >
          ...
          <div className="flex flex-col gap-2">
            ...
            <a
              href="https://github.com/kymnguyen/ag-kit/blob/main/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
              className="opacity-75 hover:opacity-100"
            >
            ...
            <a
              href="https://github.com/kymnguyen/ag-kit/blob/main/SECURITY.md"
              target="_blank"
              rel="noopener noreferrer"
              className="opacity-75 hover:opacity-100"
            >
