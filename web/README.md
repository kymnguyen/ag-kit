<p align="center">
  <img src="https://raw.githubusercontent.com/kymnguyen/ag-kit/main/web/public/images/logo.png" width="128" height="128" alt="AGKIT">
</p>
...
When downstream developers run `npx @kymnguyen/ag-kit init`, they install a `.agents/` folder at their project root:
...
*   **[GitHub Repository](https://github.com/kymnguyen/ag-kit)**
...
<a href="https://buymeacoffee.com/kymnguyen" target="_blank"><img src="https://img.shields.io/badge/Buy%20Me%20a%20Coffee-ffdd00?style=for-the-badge&logo=buy-me-a-coffee&logoColor=black" alt="Buy Me a Coffee" /></a>

**Vietnamese Bank (MBBank QR):**<br/>
<img src="https://img.kymnguyen.io/image/mbbank-0779440918-compact.jpg" alt="Donate QR" width="140" style="border-radius: 8px; margin-top: 10px;" />

---

## 📄 License

Released under the [MIT License](LICENSE) © [Loinguyen](https://github.com/kymnguyem).
