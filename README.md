<p align="center">
  <img src="https://raw.githubusercontent.com/kymnguyen/ag-kit/main/web/public/images/logo.png" width="128" height="128" alt="AG Kit">
</p>
...
```bash
npx @kymnguyen/ag-kit init
```

Or install the CLI globally:

```bash
npm install -g @kymnguyen/ag-kit
ag-kit init
```
...
<p align="center">
  <img src="https://img.kymnguyen.io/image/mbbank-0779440918-compact.jpg" alt="Buy me coffee" width="200" />
</p>
...
Released under the [MIT License](LICENSE) © [Loinguyen](https://github.com/kymnguyen).
